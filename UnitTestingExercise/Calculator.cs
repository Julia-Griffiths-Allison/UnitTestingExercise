...
namespace UnitTestingExercise
{
    public class Calculator
    {
        ...
        // Right-click on the 'Dependencies' folder in your UnitTestingExercise.Tests
        // project and add your reference to the UnitTestingExercise project

        // Step 2: Create an Add method that accepts 3 integers, adds those integers,
